    ...
    fn visual_baseline_script_validates_captures_metadata_and_nonblank_ppm() {
        ...
        assert_contains_all(
            ...
            &[
                ...
                "expectedRtRestirGiSpatialRendered",
                "rt_resolve_ready",
                ".\\run\\validate-nrd.ps1",
                "cargo run --features desktop --bin revolumetric",
            ],
    ...
    fn visual_baseline_manifest_covers_svgf_and_reblur_debug_cases() {
        ...
        assert_contains_all(
            ...
            &[
                ...
                "\"rtDebugView\": \"surface\"",
                "\"rtDebugView\": \"off\"",
                "\"rtDebugView\": \"gi_indirect\"",
                "\"rtDebugView\": \"gi_reason\"",
                "\"rtRestirDi\": true",
                ...
                "\"expectedRtRestirGiSpatialRendered\": true",
        ...
        assert_contains_all(
            ...
            &[
                ...
                "\"expectedMinRgbRange\": 32",
                "\"cameraPath\": \"gallery\"",
                "\"cameraPathCenter\": \"64,32,64\"",
                "\"cameraPathRadius\": 40",
                "\"cameraPathHeight\": 36",
                "\"cameraPathPeriodFrames\": 240",
                "\"rtRestirGiSpatial\": true",
                "\"rtRestirGiSpatialSamples\": 2",
                "\"expectedRtRestirGiSpatialRendered\": true",
            ],
        ...
        let rt_gi_indirect_case = visual_baseline_case(&manifest, "rt_gi_indirect");
        assert_contains_all(
            rt_gi_indirect_case,
            &[
                "\"renderMode\": \"rt\"",
                "\"requiresRt\": true",
                "\"expectedRenderBackend\": \"rt\"",
                "\"expectedMinNonZeroPixelRatio\": 0.70",
                "\"expectedMinRgbRange\": 32",
                "\"cameraPath\": \"gallery\"",
                "\"cameraPathCenter\": \"64,32,64\"",
                "\"cameraPathRadius\": 40",
            ...
            "rt_gi_indirect visual baseline case",
        );

        let rt_gi_reason_case = visual_baseline_case(&manifest, "rt_gi_reason");
        assert_contains_all(
            rt_gi_reason_case,
            &[
                "\"renderMode\": \"rt\"",
                "\"requiresRt\": true",
                "\"expectedRenderBackend\": \"rt\"",
                "\"expectedMinNonZeroPixelRatio\": 0.95",
                "\"expectedMinRgbRange\": 32",
                "\"expectedMaxColorPixelRatios\": {",
                "\"cyan\": 0.70",
                "\"red\": 0.30",
            ...
            "rt_gi_reason visual baseline case",
        );
